...
export default function Drinks() {
  ...
  return (
    <View style={styles.container}>
        ...
        <Text style={styles.totalText}>Choose Kigali</Text>
        ...
        <View style={styles.drinkDetails}>
            ...
            <View style={styles.textSection}>
                <Text style={styles.drinkName}>Kafir Lime Vodka, LemonGrass, Ginger</Text>
                <Text style={styles.barista}>Tom Yummy - 12.5 </Text>
                <View style={styles.drinksPriceSection}>
